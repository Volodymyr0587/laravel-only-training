        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto">
                @guest
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('loginUser')) ? 'active' : '' }}" href="{{ route('loginUser') }}">Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('registerUser')) ? 'active' : '' }}" href="{{ route('registerUser') }}">Register</a>
                    </li>
                @else
